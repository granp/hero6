$(function() {
    ...
    var uiElements = function(){
        ...
        function onValidationCallback(){
            var rules = {};
            var nameVal ={};
            var prop = {required: true, maxlength: 10};

            $(".inptTxt_seat").each(function() {
                 nameVal[$(this).attr('name')] = prop;
              });
      ...
      for (i = 0; i < $bookSeat_arr.length; i++) { 
        ...
        div_con_panel.appendChild(div_heading_panel);
            ...
            for(var $Key in $textfields) {
              ...
              nameVal[$bookSeat_arr[i]+"_"+$Key] = prop;
...
/*end busbooking.blade.php toggle seatmap, change color*/
                    ...
                    onShowStep: function(obj){                        
                        ...
                        if(wizard.hasClass("show-submit")){
                            ...
                            if(step_num == step_max){                             
                                ...
                                obj.parents(".wizard").find(".actionBar .btn-primary").css("display","none");//added
                            }                         
                        }
                        return true;                         
                    },//End
        ...
        //return id attribute to hiddent text file before submit the form
        function onFinishCallback(){
            var allVal = '';
            var selectedSeat_arr = new Array();

              $(".selectedSeat").each(function() {
                 allVal = $(this).attr('id').split("-");
                    selectedSeat_arr.push(allVal[2]);
              });
               // alert(selectedSeat_arr);

              $('#seatsdata').val(selectedSeat_arr);

              $('form').submit();
              // var prop = {required: true, maxlength: 10}
          }

        // //return name attribute to hiddent text file before submit the form
        // function onFinishCallback(){
        //     var allVal = '';
        //     var selectedSeat_arr = new Array();

        //       $(".inptTxt_seat").each(function() {
        //             selectedSeat_arr.push($(this).attr('name'));
        //       });
